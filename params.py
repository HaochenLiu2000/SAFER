...
def get_params():
    ...
    args.add_argument("--train_num", type=int)
    ...
    args.add_argument("-step", "--step", default="pretrain", type=str, choices=['train', 'test', 'dev', 'test_roc', 'pretrain' , 'tune', 'opt_test',"mytest1","model1","model2","pretrain2"])
    ...
    args.add_argument("-prev_state_dir_model2", "--prev_state_dir_model2", default=None, type=str)
